<section id="header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center text-uppercase fw-semibold">faq</h2>
            </div>
        </div>
    </div>
</section>

<section class="faq" style="padding: 150px 0px;">
    <div class="container">
                ...
                <div class="accordion" id="accordionPanelsStayOpenExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="tiga" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                            <div class="accordion-body">
                                Layanan catering kami saat ini hanya tersedia untuk Tangerang Raya
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="enam" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
                            <div class="accordion-body">
                                Perubahan atau pembatalan pesanan dapat dilakukan sesuai dengan kebijakan kami. Harap hubungi kontak kami untuk pembatalan pesanan lebih lanjut.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
