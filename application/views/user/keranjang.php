                ...
                <?php if (!empty($keranjang)) : ?>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                                    ...
                                    ?>
                                        <tr align="center">
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('user/hapusKeranjang/' . $item['id_keranjang']); ?>" class="btn btn-sm btn-danger" onclick="return confirm ('Apakah anda yakin untuk meghapus data ini')">
                            ...
                            <div class="mt-2">
                                <a href="<?= base_url('checkout'); ?>" class="btn btn-hijau px-3">Checkout</a>
                            </div>
                        </div>
                    </div>
                <?php else : ?>
                    ...
                    <a href="<?= base_url('paket'); ?>" class="btn btn-hijau px-3">Lanjutkan Belanja</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
