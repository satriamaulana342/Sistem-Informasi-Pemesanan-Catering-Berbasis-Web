...
<section class="paket" style="padding: 150px 0;">
                    ...
                    <div class="tab-pane fade show active" id="semua" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="row px-3 px-md-0">
                            <?php foreach ($paket as $data) : ?>
                                ...
                                <div class="card" style="width: 300px; height: 450px; display: flex; flex-direction: column; justify-content: space-between;">
    <img src="<?= base_url('assets/img/upload_paket/' . $data['foto']); ?>" class="card-img-top" alt="<?= ucwords($data['nama_paket']); ?>" style="height: 200px; object-fit: cover;">
    <div class="card-body" style="flex-grow: 1; display: flex; flex-direction: column; justify-content: space-between;">
        ...
        <div>
            <a href="<?= base_url('detail_prasmanan/' . $data['id_paket']); ?>" class="btn btn-hijau">Add to Cart</a>
            <a href="<?= base_url('detail_custom_prasmanan/' . $data['id_paket']); ?>" class="btn btn-secondary">Custom</a>
        </div>
    </div>
</div>
